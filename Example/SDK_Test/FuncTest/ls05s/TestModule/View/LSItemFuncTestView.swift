...
class LSItemFuncTestView: UIView {
    ...
    let settings = WatchFunction(column: "手表设置", item: ["获取MTU","配置设备","获取设备信息", "同步手机信息", "同步用户信息","设置天气","设置心率采样间隔", "设置久坐间隔","设置喝水间隔",  "设置免打扰", "设置国家", "设置UI风格", "设置时间格式", "设置公英制", "设置亮屏时长", "设置心率预警", "获取心率", "设置通知提醒",  "设置固件升级",   "获取实时心率", "设置免打扰开关",  "同步步数",  "获取功能项目",  "设置提醒数据", "设置血氧采样间隔", "获取血氧采样间隔", "发送App状态","同步时间","设置常用参数"])
